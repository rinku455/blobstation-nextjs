        ...
        <div className={styles.container}>
          <Row className={styles.our_story_row}>
            ...
            >
              ...
              <h2>Our Story</h2>
              <h3>
                The Story of Blobstation is polished with hard work and colored
                with successfully delivered solutions
              </h3>
              <p>
                ...
                relationships with clients while building digital solutions for
                them and that's the primary reason we are being loved by all of
                our clients.
              </p>
              </div>
            </Col>
            <Col
              ...
              xl={{ span: 12 }}
            >
              <img className={styles.story_img} src="images/our-story1.png"/>
            </Col>
          </Row>
          ...
          <Row  className={styles.about_row}>
            ...
            >
              ...
              <img className={styles.story_img} src="images/our-story2.png"/>
            </Col>
            <Col
              xs={{ span: 24 }}
              md={{ span: 24}}
